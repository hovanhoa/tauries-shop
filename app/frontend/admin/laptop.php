                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    <button class="btn btn-add btn-primary" type="button">Add new laptop</button>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
...
<!-- View modal -->
<div class="modal fade" id="viewLaptopModal">
...
<div class="modal fade" id="addLaptopModal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Laptop</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="addLaptopForm">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Name</label>
                        <input class="form-control" placeholder="Laptop Name" type="text" name="name"/>
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <input class="form-control" placeholder="Laptop Description" type="text" name="description"/>
                    </div>
                    <div class="form-group">
                        <label>Brand</label>
                    ...
                    <div class="form-group">
                        <label>Price</label>
                        <input class="form-control" placeholder="Laptop Price" type="number" name="price"/>
                    </div>
                    <div class="form-group">
                        <label>Image</label>
...
<!-- Delete modal -->
<div class="modal fade" id="deleteLaptopModal">
    <div class="modal-dialog">
