            ...
            <div class="pagination" style="float:right; margin-right: 15px; margin-bottom: 15px;">
                <?php 
                    ...
                    if ($current_page > 1 && $total_page > 1){
                        if (isset($_GET['brand'])) echo '<li class="page-item"><a  class="page-link" href="laptop.php?page='.($current_page-1).'&brand='.$_GET['brand'].'">Prev</a><li>';
                        else echo '<li class="page-item"><a  class="page-link" href="laptop.php?page='.($current_page-1).'">Prev</a></li>';
                    }
                    ...
                    for ($i = 1; $i <= $total_page; $i++){
                        ...
                        if ($i == $current_page){
                            ...
                            if (isset($_GET['brand'])) echo '<li class="page-item"><a  class="page-link" href="laptop.php?page='.$i.'&brand='.$_GET['brand'].'">'.$i.'</a></li>';
                            else echo '<li class="page-item"><a  class="page-link" href="laptop.php?page='.$i.'">'.$i.'</a></li>';
                        }
                    }
        
                    // nếu current_page < $total_page và total_page > 1 mới hiển thị nút prev
                    if ($current_page < $total_page && $total_page > 1){
                        if (isset($_GET['brand'])) echo '<li class="page-item"><a  class="page-link" href="laptop.php?page='.($current_page+1).'&brand='.$_GET['brand'].'">Next</a><li>';
                        else echo '<li class="page-item"><a  class="page-link" href="laptop.php?page='.($current_page+1).'">Next</a></li>';
                    }
                ?>
            </div>
        </div>
